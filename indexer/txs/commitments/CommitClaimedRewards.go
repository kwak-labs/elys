...
type CommitClaimedRewards struct {
	Address string `json:"sender_address"`
	Amount  string `json:"amount"`
	Denom   string `json:"denom"`
}

func (m CommitClaimedRewards) Process(database types.DatabaseManager, transaction types.BaseTransaction) (types.Response, error) {
